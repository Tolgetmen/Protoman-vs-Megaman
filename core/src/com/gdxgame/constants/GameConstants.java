...
public final class GameConstants {
	...
	public static final String	PREFERENCE_CFG_NAME			= "ProtoVsMegaCfg";
	public static final String	PREFERENCE_KEY_WIDTH		= "windowWidth";
	public static final String	PREFERENCE_KEY_HEIGHT		= "windowHeight";
	public static final String	PREFERENCE_KEY_FULLSCREEN	= "fullscreen";
	public static final String	PREFERENCE_KEY_MUSIC_VOLUME	= "musicVolume";
	public static final String	PREFERENCE_KEY_SOUND_VOLUME	= "soundVolume";
