...
public class GSMainMenuLogic extends MenuLogic {
	...
	public void initialize() {
		...
		menu = new MegamanMenu(GameUtils.getLocalizedLabel("MainMenu.title"), this, GameConstants.GAME_WIDTH, GameConstants.GAME_HEIGHT, true, GameMenuPageType.MAIN_MENU_MAIN);
	}
}
